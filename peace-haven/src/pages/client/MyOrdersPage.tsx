...
import {
  Search, ChevronRight, Sprout, MapPin, Calendar, Clock,
  ClipboardList, X, Phone, Drone as DroneIcon, Link as LinkIcon
} from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto px-5 py-10 md:py-12 relative z-10">
          ...
          <div className="flex flex-col gap-3 w-full md:w-auto">
            ...
            <div className="relative border border-black bg-white">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-transparent focus:outline-none font-bold text-[10px] uppercase tracking-widest placeholder:text-zinc-200"
              />
            </div>
            {/* Filter tabs */}
                  ...
                  >
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-8 flex-1">
                      ...
                      <div className="flex items-center gap-2.5 w-36">
                        <div className="w-8 h-8 border border-black flex items-center justify-center bg-brand-accent">
                          <Sprout size={16} />
                        </div>
                        <div>
                          <p className="text-[8px] font-black text-zinc-400 uppercase tracking-[0.2em]">Pesticide</p>
                          <p className="text-sm font-black uppercase tracking-tight">{order.cropType}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2.5 w-36">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-black uppercase tracking-tight">{order.area}</p>
                        </div>
                      </div>
                      <div>
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-20 border border-black bg-zinc-50">
            ...
            <h3 className="text-2xl font-black uppercase tracking-tighter mb-1.5">No orders found</h3>
