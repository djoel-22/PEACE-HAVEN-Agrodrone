...
// ─── Backend Types (exactly matching actual API responses) ────────────────────
...
// NOTE: _job_dict returns "start" and "end", NOT "start_time"/"end_time"
...
// NOTE: Matches backend JobCreate pydantic model exactly
